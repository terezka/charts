...
view model =
  ...
  , body = \_ ->
      ...
      , E.el [ F.size 18 ] (E.text "Womens percentage of mens salery")
      ...
      , E.row
          ...
          let button year =
                ...
                , E.focused
                    [ BG.color (if year == model.year then E.rgb255 245 245 245 else E.rgb255 250 250 250)
                    ]
                  ]
                  { onPress = Just (OnYear year)
                  , label =
                      E.column
                        [ E.width E.fill, E.spacing 10 ]
                        [ E.el [ F.size 14 ] (E.text (String.fromFloat year))
                        , E.text "Women earn 0.85 per 1 DKK"
                        ]
                  }
          in
          [ button 2019
