...
type alias Model =
  ...
  , example21 : Examples.Navigation.Dimensions.Model
  , example22 : Examples.Navigation.NoArrow.Model
  , example23 : Examples.Navigation.OnlyInts.Model
  , example24 : Examples.Navigation.Offset.Model
...
init =
  ...
  , example21 = Examples.Navigation.Dimensions.init
  , example22 = Examples.Navigation.NoArrow.init
  , example23 = Examples.Navigation.OnlyInts.init
  , example24 = Examples.Navigation.Offset.init
...
type Msg
  ...
  | ExampleMsg21 Examples.Navigation.Dimensions.Msg
  | ExampleMsg22 Examples.Navigation.NoArrow.Msg
  | ExampleMsg23 Examples.Navigation.OnlyInts.Msg
  | ExampleMsg24 Examples.Navigation.Offset.Msg
...
update msg model =
  case msg of
    ...
    ExampleMsg21 sub -> { model | example21 = Examples.Navigation.Dimensions.update sub model.example21 }
    ExampleMsg22 sub -> { model | example22 = Examples.Navigation.NoArrow.update sub model.example22 }
    ExampleMsg23 sub -> { model | example23 = Examples.Navigation.OnlyInts.update sub model.example23 }
    ExampleMsg24 sub -> { model | example24 = Examples.Navigation.Offset.update sub model.example24 }
...
view model chosen =
  case chosen of
    ...
    Navigation__Dimensions -> Html.map ExampleMsg21 (Examples.Navigation.Dimensions.view model.example21)
    Navigation__NoArrow -> Html.map ExampleMsg22 (Examples.Navigation.NoArrow.view model.example22)
    Navigation__OnlyInts -> Html.map ExampleMsg23 (Examples.Navigation.OnlyInts.view model.example23)
    Navigation__Offset -> Html.map ExampleMsg24 (Examples.Navigation.Offset.view model.example24)
