module Examples.Interactivity.Focal exposing (..)
...
view model =
  C.chart
    ...
    , C.each model.hovering <| \p item ->
        [ C.tooltip item [ CA.topCenter, CA.onLeftOrRight ] [] [] ]
    ]
...
meta =
  ...
  , categoryOrder = 5
  , name = "Set focal point"
  , description = "Determine where tooltip is placed in relation to item."
  , order = 11
  }
