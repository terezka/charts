module Examples.Interactivity.Tricky exposing (..)
...
view model =
  C.chart
    ...
    , C.yLabels []
    , C.bars [] [ C.bar .v [] ] data
    , C.bars [] [ C.bar .y [ CA.color CA.blue ] ] data
    , C.series .x
        [ C.property .z [ CA.color CA.purple ] []
        , C.property .w [ CA.color CA.green ] []
        ]
        data
...
meta =
  ...
  , categoryOrder = 5
  , name = "Tricky overlappings"
  , description = "Add tooltip to overlapping products"
  , order = 1
  }
